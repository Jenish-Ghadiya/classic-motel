...
export default function Lodges() {
    return (
        <section className="lodges-section" id="lodges">
            <div className="lodges-banner">
                <p>Welcome to classic motel lodges</p>
                <h2>Explore Chalets & Lodges</h2>
                <p>
                    Offering our guests a historic atmosphere with modern
                    conveniences.
                </p>
            </div>
            <div className="container">
                <div className="lodges-grid">
                    <div className="lodges">
                        ...
                        <div className="lodges-detail">
                            <h3>Meadow Chalet</h3>
                            <p>120 m² / Great Mountain View / 6 Guests</p>
                            <div className="lodges-sub-detail">
                                <div className="lodges-svg">
                                    <svg
                                        id="Layer_1"
                                        data-name="Layer 1"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 122.88 82.26"
                                    >
                            ...
                            <p>
                                The dark wood panelling and furnishings,
                                red-draped fourposter bed, and black stone
                                bathroom evoke the charm of a secluded Sierra
                                Nevada.
                            </p>
